  ...
  return (
    <>
      <Row>
        <Col>
        <br/>
          <Image alt="THE MET" src="https://upload.wikimedia.org/wikipedia/commons/3/30/Metropolitan_Museum_of_Art_%28The_Met%29_-_Central_Park%2C_NYC.jpg" className='img-fluid rounded'/>
        </Col>
      </Row>
      <Row>
        <Col md={6}>
